    ...
    <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Edit This Attribute Type</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate
                              action="<?php echo $this->Url->build('/', true) ?>AttributeTypes/AdminsingleEditTypeData" method="post">
                            <span class="section">Edit Attribute Type Information</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Attribute Type Name
                                    <span
                                        class="required">*</span>
                                </label>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control "
                                           ...
                                           name="attribute_type_name" value="<?php echo $attributeTypes->attribute_type_name; ?>"
                                           placeholder="" required="required" type="text">
                                </div>

                                <input type="hidden" name="attribute_type_id"
                                       value="<?php echo $attributeTypes->attribute_type_id; ?>">
                            </div>
