    ...
    <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Edit This Product Categories</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate
                              action="<?php echo $this->Url->build('/', true) ?>ProductCategories/AdminsingleCategoryData"
                              method="post">
                            <span class="section">Edit Product Categories Information</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Product Categories
                                    Name
                                    <span
                                        class="required">*</span>
                                </label>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control "
                                           ...
                                           name="category_name" value="<?php echo $productCategories->category_name; ?>"
                                           placeholder="" required="required" type="text">
                                </div>

                                <input type="hidden" name="category_id"
                                       value="<?php echo $productCategories->category_id; ?>">
                            </div>
