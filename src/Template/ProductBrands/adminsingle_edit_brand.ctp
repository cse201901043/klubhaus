                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate
                              action="<?php echo $this->Url->build('/', true) ?>ProductBrands/singleEditProductBrandData" method="post">
                            <span class="section">Edit Product Brand Information</span>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control "
                                           ...
                                           name="brand_name" value="<?php echo $productBrand->brand_name; ?>"
                                           placeholder="" required="required" type="text">
                                </div>

                                <input type="hidden" name="brand_id"
                                       value="<?php echo $productBrand->brand_id; ?>">
                            </div>
