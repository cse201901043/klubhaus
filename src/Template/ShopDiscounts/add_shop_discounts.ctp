                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate enctype="multipart/form-data"
                              action="<?php echo $this->Url->build('/', true) ?>ShopDiscounts/addShopDiscountsData" method="post">
