    ...
    <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Edit This Attribute Value</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate
                              action="<?php echo $this->Url->build('/', true) ?>AttributeValues/AdminsingleEditValuesData" method="post">
                            <span class="section">Edit Attribute Value Information</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Attribute Value Name
                                    <span
                                        class="required">*</span>
                                </label>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control "
                                           ...
                                           name="attribute_field_value" value="<?php echo $attributeValue->attribute_field_value; ?>"
                                           placeholder="" required="required" type="text">
                                </div>

                                <input type="hidden" name="attribute_field_id"
                                       value="<?php echo $attributeValue->attribute_field_id; ?>">
                            </div>
